...
<head>
    ...
    <title>Escritorio | <?php echo ConfigData::getByKey("navbar_text")->description;?></title>
    <link rel="icon" type="image/png" href="../../storage/images/favicon.png">
    <script src="res/ckeditor.js"></script>
    <script src="res/js/sample.js"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><b><?php echo ConfigData::getByKey("navbar_text")->description;?></b> <sup>V - 0.1</sup></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-left top-nav">
            <li><a href="./">Ver Página</a></li>
            <li><a href="./?r=admin/newpost"><i class="fa fa-asterisk"></i> Nueva Públicación</a></li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="./?r=admin/index"><i class="fa fa-fw fa-dashboard"></i> Escritorio</a>
                    </li>
                    <li>
                        <a href="./?r=admin/posts"><i class="fa fa-fw fa-th-large"></i> Públicaciones</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-cogs"></i> Configuraciones <i class="fa fa-fw fa-caret-down"></i></a>
...
<br><br><br><br><br><div class="container">
  ...
  <div class="form-group">
    <input type="text" name="email" class="form-control" id="exampleInputEmail1" placeholder="Correo electronico" autocomplete="off">
  </div>
  <div class="form-group">
...
<br>  <a href="./?r=auth/recover">¿Olvide mi contraseña?</a>
</form>
        </div>
        </div>
        <!-- -->
